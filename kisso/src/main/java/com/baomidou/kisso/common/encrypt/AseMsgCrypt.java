...
import com.baomidou.kisso.common.parser.XMLParser;
...
public class AseMsgCrypt {
	...
	public String encrypt(String randomStr, String text) throws AesException {
		...
		byte[] randomStrBytes = randomStr.getBytes(SSOConfig.CHARSET_ENCODING);
	...
	public String encryptMsg(String replyMsg, String timeStamp, String nonce) throws AesException {
		...
		/* 随机生成16位字符串混淆加密 */
		String encrypt = encrypt(RandomUtil.getCharacterAndNumber(16), replyMsg);
